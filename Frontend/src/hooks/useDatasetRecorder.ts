...
// fixed enum.
export const DEFAULT_SIGN_LABELS = ['HELLO', 'WAVE_GREETING', 'THANK_YOU', 'PLEASE', 'SORRY', 'YES', 'NO', 'HELP', 'WELCOME', 'FRIEND', 'MORE', 'WATER', 'FOOD', 'PAIN', 'DOCTOR', 'MEDICINE', 'WHERE', 'WHAT', 'WHO', 'UNDERSTAND' ]
